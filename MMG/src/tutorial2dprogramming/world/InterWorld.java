...
public class InterWorld extends World{
    ...
    public void setCreatures() {
        ...
        GrabbableStar star1=new GrabbableStar(handler, 2688, 2750, 32, 32); 
        GrabbableStar star2=new GrabbableStar(handler, 450, 958, 32, 32);  
        GrabbableStar star3=new GrabbableStar(handler, 1920, 1570, 32, 32); 
