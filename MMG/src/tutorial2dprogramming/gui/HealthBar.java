...
public class HealthBar extends ObservingPanel {
    ...
    public HealthBar() throws IOException {
        ...
        healthTrapeze = ImageLoader.loadImage("/gui/healthbg.png");//ImageIO.read(this.getClass().getResource("/res/gui/healthbg.png"));
        heartIcon = ImageLoader.loadImage("/gui/heart_icon.png");//ImageIO.read(this.getClass().getResource("/res/gui/heart_icon.png"));
    ...
    public void paint(Graphics g) {
        ...
        String remainingLife = String.format("%1$" + 10 + "s", this.value + "/120 HP");
    ...
    public void update(Observable o, Object arg) {
        Life v = (Life) o; //To change body of generated methods, choose Tools | Templates.
        this.value = v.getHealth();
        this.lifes = v.getLifes();
        this.repaint();
    }
