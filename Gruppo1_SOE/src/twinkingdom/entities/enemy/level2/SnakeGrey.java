...
import twinkingdom.gfx.SnakeGreyAssets;

/**
 *
 * @author Alex1
 */
public class SnakeGrey extends Enemy {
    
       
    public SnakeGrey(Handler handler, float x, float y, int width, int height, SnakeGreyAssets entityAssets) {
