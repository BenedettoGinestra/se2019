...
import twinkingdom.gfx.SnakeBlueAssets;

/**
 *
 * @author Alex1
 */
public class SnakeBlue extends Enemy {
    
        
    public SnakeBlue(Handler handler, float x, float y, int width, int height, SnakeBlueAssets entityAssets) {
