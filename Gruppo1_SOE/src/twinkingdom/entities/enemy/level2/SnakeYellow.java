...
import twinkingdom.gfx.SnakeYellowAssets;

/**
 *
 * @author Alex1
 */
public class SnakeYellow extends Enemy{
    
        
    public SnakeYellow(Handler handler, float x, float y, int width, int height, SnakeYellowAssets entityAssets) {
