 ...
 * @author Alex1
 */
public class SnakeRedAssets extends EntityAssets {
    ...
    public void init(){
        ...
        int startingXAttack= 6*width;
        int startingYAttack= 4*height;
        SpriteSheet sheet1, sheet2, sheet = null;            
        sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/snake2.png"));
        ...
        for(int i=0;i<3;i++){
            ...
            //sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/EBros_snake_samurai/snake_Samurai_Walk.png"));
