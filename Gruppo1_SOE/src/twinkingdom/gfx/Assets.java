...
public class Assets {
    ...
    public static void init() {
        SpriteSheet sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/textures/sheet.png"));
        SpriteSheet tileset = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/textures/tileset.png"));
        SpriteSheet final_tileset = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/textures/Forest Tileset-min.png"));
        ...
        SpriteSheet sheet5 = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/STELLE.png"));
        ...
        //SpriteSheet sheet6 = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/healthPotion.png"));
        healthPotion[0] = ImageLoader.loadImage("/twinkingdom/images/health.png");
        
        SpriteSheet sheet6 = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/portalRings2.png"));
        ...
        enchantedTrees[0]=ImageLoader.loadImage("/twinkingdom/images/enchantedTree3.png");

        enchantedLeaf[0]=ImageLoader.loadImage("/twinkingdom/images/enchantedLeaf.png");
