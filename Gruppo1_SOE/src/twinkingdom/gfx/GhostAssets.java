...
public class GhostAssets extends EntityAssets {
    ...
    public void init(){
        ...
        sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/ghost2.png"));
        ...
        for(int i=0;i<6;i++){
            ...
            //sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/EBros_ghost_samurai/ghost_Samurai_Walk.png"));
