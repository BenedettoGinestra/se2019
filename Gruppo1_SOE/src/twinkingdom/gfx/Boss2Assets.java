...
public class Boss2Assets extends EntityAssets {
    ...
    public void init(){
        ...
        BufferedImage[] boss2_down_attack = new BufferedImage[9];
        BufferedImage[] boss2_up_attack= new BufferedImage[9];
        BufferedImage[] boss2_left_attack= new BufferedImage[9];
        BufferedImage[] boss2_right_attack=new BufferedImage[9];
        ...
        sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/Boss2.png"));
        ...
        for(int i=0;i<9;i++){
            ...
            //sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/EBros_boss2_samurai/boss2_Samurai_Walk.png"));
