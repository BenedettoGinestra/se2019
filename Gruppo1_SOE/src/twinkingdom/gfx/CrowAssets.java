...
public class CrowAssets extends EntityAssets{
    ...
    public void init(){
        ...
        sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/crow.png"));
        ...
        for(int i=0;i<4;i++){
            ...
            //sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/EBros_crow_samurai/crow_Samurai_Walk.png"));
