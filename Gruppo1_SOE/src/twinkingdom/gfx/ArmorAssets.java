...
public class ArmorAssets extends EntityAssets {
    ...
    public void init(){
        ...
        sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/darksoldier.png"));
        ...
        for(int i=0;i<5;i++){
            ...
            //sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/EBros_armor_samurai/armor_Samurai_Walk.png"));
