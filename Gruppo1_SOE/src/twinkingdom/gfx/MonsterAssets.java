...
public class MonsterAssets extends EntityAssets{
    ...
    public void init(){
        ...
        sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/Enemy_Ranged_v01.png"));
        ...
        for(int i=0;i<=4;i++){
            ...
            //sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/EBros_monster_samurai/monster_Samurai_Walk.png"));
            if(i<=11){
