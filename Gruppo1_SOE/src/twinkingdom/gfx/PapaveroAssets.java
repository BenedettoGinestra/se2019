...
public class PapaveroAssets extends EntityAssets {
    ...
    public void init(){
        ...
        sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/papavero2.png"));
        ...
        for(int i=0;i<3;i++){
            ...
            //sheet = new SpriteSheet(ImageLoader.loadImage("/twinkingdom/images/EBros_papavero_samurai/papavero_Samurai_Walk.png"));
